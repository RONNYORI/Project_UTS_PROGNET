...
$dataJurusan = $master->getUpdateJurusan($_GET['id']);
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<h3 class="card-title">Formulir Jurusan</h3>
                                    ...
                                    <form action="proses/proses-prodi.php?aksi=updatejurusan" method="POST">
									    <div class="card-body">
                                            <div class="mb-3">
                                                <label for="nama" class="form-label">Kode Jurusan</label>
                                                <input type="text" class="form-control-plaintext" id="kode" name="kode" placeholder="Masukkan Kode Program Studi" value="<?php echo $dataJurusan['kode']; ?>" required readonly>
                                            </div>
											<div class="mb-3">
												<label for="nama" class="form-label">Nama Jurusan</label>
												<input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Program Studi" value="<?php echo $dataJurusan['nama']; ?>" required>
											</div>
                                        </div>
