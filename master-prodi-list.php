							...
							<div class="col-12">
								<div class="card">
														...
														foreach ($dataJurusan as $index => $jurusan){
															echo '<tr class="align-middle">
																...
																<td class="text-center">
																	<button type="button" class="btn btn-sm btn-warning me-1" onclick="window.location.href=\'master-prodi-edit.php?id='.$jurusan['kode'].'\'"><i class="bi bi-pencil-fill"></i> Edit</button>
																	<button type="button" class="btn btn-sm btn-danger" onclick="if(confirm(\'Yakin ingin menghapus data program studi ini?\')){window.location.href=\'proses/proses-prodi.php?aksi=delete&id='.$jurusan['kode'].'\'}"><i class="bi bi-trash-fill"></i> Hapus</button>
																</td>
															</tr>';
														}
													}
									...
									<div class="card-footer">
										<button type="button" class="btn btn-primary" onclick="window.location.href='master-prodi-input.php'"><i class="bi bi-plus-lg"></i> Tambah Jurusan</button>
									</div>
								</div>
							</div>
						</div>
