...
if($_GET['aksi'] == 'inputjurusan'){
    ...
    $input = $master->inputJurusan($dataJurusan);
    if($input){
...
} elseif($_GET['aksi'] == 'updatejurusan'){
    ...
    $update = $master->updateJurusan($dataJurusan);
    if($update){
